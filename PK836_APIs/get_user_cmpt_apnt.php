...
if (isset($_POST["USERID"]) && isset($_POST["APNT_STATUS"])) {
    ...
    $checkQuery = "SELECT login_table.F_NAME, login_table.L_NAME, appointment_details.* FROM login_table LEFT JOIN appointment_details ON login_table.USERID = appointment_details.OP_ID WHERE `APNT_STATUS`= 'COMPLETED' AND appointment_details.USERID = '$USERID'"; // change here.
