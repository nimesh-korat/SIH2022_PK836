...
$checkQuery = "SELECT login_table.F_NAME, login_table.L_NAME, appointment_details.* FROM login_table LEFT JOIN appointment_details ON login_table.USERID = appointment_details.USERID WHERE appointment_details.APNT_STATUS = 'COMPLETED';
 "; // change here.
