...
if (isset($_POST["OP_ID"])) {
    ...
    $checkQuery = "SELECT appointment_details.* FROM appointment_details LEFT JOIN op_fetch_appt ON op_fetch_appt.APPT_ID = appointment_details.APNT_ID WHERE op_fetch_appt.APPT_STATUS= 'ACCEPTED' AND op_fetch_appt.OP_ID = '$OP_ID'"; // change here.
