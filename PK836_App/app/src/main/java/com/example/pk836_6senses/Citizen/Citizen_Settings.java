...
public class Citizen_Settings extends MyBaseActivity_Citizen {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.activity_citizen_settings, null, false);
        drawer.addView(v, 0);
        ...
        change_lang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(Citizen_Settings.this);
