...
public class Completed_apnt_Citizen extends MyBaseActivity_Citizen {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.activity_completed_apnt_citizen, null, false);
        drawer.addView(v, 0);

        recyclerView = findViewById(R.id.rv_user_get_comp_rqst);
        mSwipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.citizen_cmpt_swipeTorefresh);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                radapter = new RecyclerAdapter(getAllData(), Completed_apnt_Citizen.this);
                recyclerView.setAdapter(radapter);
            }
        });
    ...
    private List<Appt_Model> getAllData() {
        ...
        class UserLogin extends AsyncTask<Void, Void, String> {
            ...
            protected String doInBackground(Void... voids) {
                ...
                params.put("APNT_STATUS", "COMPLETED");
                params.put("USERID", uid);
                return requestHandler.sendPostRequest(URLs.URL_GET_USER_APNT_HISTORY, params);
        ...
        public void onBindViewHolder(@NonNull RecyclerAdapter.MyviewHolder holder, @SuppressLint("RecyclerView") final int position) {
            ...
            holder.cardView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(context, Comp_Appt_Details_Citizen.class);
                    intent.putExtra("ID", current1.getAPNT_ID());
                    intent.putExtra("OP_ID", current1.getOP_ID());
                    intent.putExtra("NAME", current1.getF_NAME() + " " + current1.L_NAME);
                    intent.putExtra("BOOKED DATE", current1.getAPNT_PEND_DT());
                    intent.putExtra("COMPLETED DATE", current1.getAPNT_CMPT_DT());
