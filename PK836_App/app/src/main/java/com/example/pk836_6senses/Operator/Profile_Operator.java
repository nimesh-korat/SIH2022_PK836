...
import com.example.pk836_6senses.Citizen.Profile_Citizen;
...
public class Profile_Operator extends MyBaseActivity_Operator implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.activity_profile_operator, null, false);
        drawer.addView(v, 0);

        fname = findViewById(R.id.operator_fname_profile);
        name = findViewById(R.id.operator_fullname_profile);
        lname = findViewById(R.id.operator_lname_profile);
        dp = findViewById(R.id.op_profile_image);
        email = findViewById(R.id.operator_email_profile);
        phone = findViewById(R.id.operator_phone_profile);
        address = findViewById(R.id.operator_address_profile);
        pincode = findViewById(R.id.operator_pin_profile);
        dob = findViewById(R.id.operator_dob_profile);
        gender = findViewById(R.id.operator_gender_profile);
        btn_update = findViewById(R.id.btn_operator_update_profile);
        btn_pincode = findViewById(R.id.btn_operator_get_pin_profile);
        progressBar = findViewById(R.id.progressBar_profile_operator);
        ...
        Glide.with(Profile_Operator.this).load(merged_path).into(dp);
        ...
        dob.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(
                        Profile_Operator.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        class UserLogin extends AsyncTask<Void, Void, String> {
            ...
            protected void onPostExecute(String s) {
                ...
                try {
                    ...
                    Toast.makeText(Profile_Operator.this, "Pin-Code Verified Successfully", Toast.LENGTH_SHORT).show();
    ...
    private void updateProfile() {
        ...
        String u_dob = dob.getEditText().getText().toString();
            ...
            protected void onPostExecute(String s) {
                ...
                try {
                    ...
                    if (!obj.getBoolean("error")) {
                        ...
                        Intent Page = new Intent(Profile_Operator.this, Home_Activity_Operator.class);
                        startActivity(Page);
